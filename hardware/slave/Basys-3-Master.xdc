...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports btn_send_sw]
...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 PULLUP true } [get_ports {uart_rx}];#Sch name = JB9
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports {uart_tx}];#Sch name = JB10
