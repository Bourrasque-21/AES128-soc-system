module aes128_gcm_pipeline_context #(
    ...
    assign input_last_word = DECRYPT ? 5'd19 : 5'd15;
    ...
    always_comb begin
        unique case (req_count)
            REQ_H: begin
                aes_req_block = ZERO_BLOCK;
            end
            REQ_TAG_MASK: begin
                aes_req_block = {nonce, 32'h00000001};
            end
            REQ_KS0: begin
                aes_req_block = {nonce, 32'h00000002};
            end
            REQ_KS1: begin
                aes_req_block = {nonce, 32'h00000003};
            end
            REQ_KS2: begin
                aes_req_block = {nonce, 32'h00000004};
            end
            default: begin
                aes_req_block = ZERO_BLOCK;
            end
    ...
    always_comb begin
        ...
        unique case (state)
            ...
            C_GHASH_PAYLOAD_START: begin
                ghash_data_in = DECRYPT ? payload_in[payload_index] :
